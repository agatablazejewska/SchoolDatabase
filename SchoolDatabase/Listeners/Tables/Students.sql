...
(
	...
	CONSTRAINT FK_StudentsDeanGroups FOREIGN KEY (StudentDeanGroupId) REFERENCES listeners.DeanGroups ON DELETE SET NULL,
	CONSTRAINT FK_StudentsStudySemesters FOREIGN KEY (StudentStudySemesterId) REFERENCES listeners.StudySemesters ON DELETE SET NULL,
